...
struct FCPXMLGeneratorTool {
    ...
    static func main() async {
        ...
        do {
            ...
            print("✅ \(video1URL.lastPathComponent): \(Int(video1Metadata.dimensions.width))x\(Int(video1Metadata.dimensions.height)) @ \(video1Metadata.frameRate)fps")
            
            let video2Metadata = try await extractor.extractMetadata(from: video2URL)
            print("✅ \(video2URL.lastPathComponent): \(Int(video2Metadata.dimensions.width))x\(Int(video2Metadata.dimensions.height)) @ \(video2Metadata.frameRate)fps")
            ...
            print("   • Multicam clip with 3 angles (Both, \(video1URL.deletingPathExtension().lastPathComponent), \(video2URL.deletingPathExtension().lastPathComponent))")
