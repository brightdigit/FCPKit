...
extension FCPXMLDiffTests {
  ...
  internal static let elementKeys: [(any DynamicNodeEncoding.Type, String)] = [
  ...
  internal static let mixedTypes: [any DynamicNodeEncoding.Type] = [
